// Este componente atua como a seção de "Animais em Destaque" para a Home Page,
// exibindo cards de pets e um card lateral para "Ver Todos os Animais".

import React, { useEffect, useState } from 'react';
import { Link } from 'react-router-dom';
import ViewAllPetsCard from '../pets/ViewAllPetsCard'; // Importa o card "Ver Todos"

import styles from '../homepage/FeaturedPetList.module.css'; // <<-- IMPORTANDO O CSS MODULE

const FeaturedPetList = () => { 
